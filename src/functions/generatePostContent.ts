    ...
    return new Promise<string>( (resolve, reject) => {
        try {
          const requestBody = {
            ...
            messages: [{ role: 'user', content: `Você é um especialista em finanças que escreve para um blog semanal chamado Bolso Cheio AI. Respire fundo, e escreva um artigo sobre ${theme}.` }],
            max_tokens: 1000,
            temperature: 0.5,
          };
